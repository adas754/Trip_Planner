...
def location_task(agent, from_city, destination_city, date_from, date_to):
    return Task(
        description=f"""
        In PUNE: Provide travel-related information including accommodations, cost of living,
        transportation, weather, and local events.
        ...
        Respond in PUNE if the destination is in a Marathi-speaking state.
        """,
